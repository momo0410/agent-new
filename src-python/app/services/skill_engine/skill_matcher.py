...
class SkillMatcher:
    ...
    SERVICE_SKILL_MAP: dict[str, str] = {
        "vsftpd": "exploit-ftp",
        "samba": "exploit-netbios-ssn",
        "smbd": "exploit-netbios-ssn",
        "unrealircd": "exploit-irc",
        "distccd": "exploit-distccd",
        "distcc": "exploit-distccd",
        "java-rmi": "exploit-java-rmi",
        "rmiregistry": "exploit-java-rmi",
        "bindshell": "exploit-bindshell",
        "backdoor": "exploit-bindshell",
        "postgresql": "exploit-postgresql",
        ...
        "ircd": "exploit-irc",
        "irc": "exploit-irc",
        "nfsd": "exploit-rpcbind",
        "mountd": "exploit-rpcbind",
        "rsh": "exploit-exec",
        "rexec": "exploit-exec",
        "apache": "exploit-http",
        "httpd": "exploit-http",
        "redis": "exploit-redis",
        "elasticsearch": "exploit-http",
        "jenkins": "exploit-http",
        "struts": "exploit-http",
    }
